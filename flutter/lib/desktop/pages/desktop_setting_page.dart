...
import 'package:camellia_remote_app/plugin/widgets/desktop_settings.dart';
                        ...
                        children: [
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'Copyright © ${DateTime.now().toString().substring(0, 4)} Camellia Computing\n$license',
