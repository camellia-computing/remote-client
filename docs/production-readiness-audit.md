...
- Shared protocol: the client and server pin commit `510eeb112b0340e612db6dd03c7c1edb3cbf90fe`; format, Clippy with warnings denied, and 104 unit tests passed.
