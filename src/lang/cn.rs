...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Upload incoming session recordings to server", "将传入会话录像上传到服务器"),
        ("Change", "更改"),
        ...
        ("Camera", "摄像头"),
        ("Choose a mode and enter a trusted device ID", "选择连接模式并输入可信设备 ID"),
        ("Chroma", "色度"),
        ("Connecting", "连接中"),
        ("Desktop", "桌面"),
        ("Devices", "设备"),
        ...
        ("Move toolbar", "移动工具栏"),
        ("Protocol", "协议"),
        ("Recent, favorite, discovered, and shared devices", "最近、收藏、发现和共享设备"),
        ("Relay", "中继"),
        ("Route", "路径"),
        ("Secure", "安全"),
        ("Session status", "会话状态"),
