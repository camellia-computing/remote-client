...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Camera", "攝影機"),
        ("Choose a mode and enter a trusted device ID", "選擇連線模式並輸入可信任的裝置 ID"),
        ("Chroma", "色度"),
        ("Connecting", "連線中"),
        ("Desktop", "桌面"),
        ("Devices", "裝置"),
        ...
        ("Move toolbar", "移動工具列"),
        ("Protocol", "通訊協定"),
        ("Recent, favorite, discovered, and shared devices", "近期、收藏、探索到及共享的裝置"),
        ("Relay", "中繼"),
        ("Route", "路徑"),
        ("Secure", "安全"),
        ("Session status", "工作階段狀態"),
        ("Target Bitrate", "目標位元速率"),
        ("View", "檢視"),
    ].iter().cloned().collect();
}
