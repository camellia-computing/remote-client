...
pub fn get_default_shell() -> String {
    // Camellia Remote supports the current PowerShell line only. Windows
    // PowerShell 5.1 and PowerShell 6 are intentionally not selected.
    let pwsh_paths = ["pwsh.exe", r"C:\Program Files\PowerShell\7\pwsh.exe"];
