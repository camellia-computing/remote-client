...
use camellia_remote_protocol::config::Config2;
use camellia_remote_protocol::tcp::{self, new_listener};
...
pub fn new() -> ServerPtr {
    let mut server = Server {
        ...
        id_count: camellia_remote_protocol::rand::random::<i32>() % 1000 + 1000, // ensure positive
    };
    ...
    if is_server {
        ...
        match crate::ipc::connect(1000, "").await {
            ...
            Err(err) => {
                ...
                if no_server {
                    camellia_remote_protocol::sleep(1.0).await;
...
async fn sync_and_watch_config_dir(sync_done_tx: Option<tokio::sync::oneshot::Sender<()>>) {
    ...
    use camellia_remote_protocol::sleep;
    for i in 1..=tries {
