...
pub use camellia_remote_protocol::ResultType;
...
fn initialize(app_dir: &str, custom_client_config: &str) {
    ...
    #[cfg(target_os = "android")]
    {
        ...
        camellia_remote_protocol::init_log(false, "");
    ...
    #[cfg(target_os = "ios")]
    {
        use camellia_remote_protocol::env_logger::*;
    ...
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
    {
        ...
        camellia_remote_protocol::init_log(false, "flutter_ffi");
    }
}
...
pub fn main_get_connect_status() -> String {
    ...
    #[cfg(any(target_os = "android", target_os = "ios"))]
    {
        let mut state = camellia_remote_protocol::config::get_online_state();
        if state > 0 {
            state = 1;
        }
...
pub fn version_to_number(v: String) -> i64 {
    camellia_remote_protocol::get_version_number(&v)
}
...
pub fn main_get_common(key: String) -> String {
    if key == "is-printer-installed" {
        ...
        return camellia_remote_protocol::fs::get_next_job_id().to_string();
