...
impl<T: InvokeUiSession> Session<T> {
        ...
        if allow_swap_key {
            ...
            msg.modifiers = msg
                ...
                .map(|ck| {
                    ...
                    camellia_remote_protocol::protobuf::EnumOrUnknown::new(ck)
                })
                .collect();
    ...
    pub fn printer_response(&self, id: i32, path: String, printer_name: String) {
        ...
        self.send(Data::SendFiles((
            id,
            camellia_remote_protocol::fs::JobType::Printer,
            path,
...
impl<T: InvokeUiSession> Interface for Session<T> {
    ...
    fn swap_modifier_mouse(&self, msg: &mut camellia_remote_protocol::protos::message::MouseEvent) {
        let allow_swap_key = self.get_toggle_option("allow_swap_key".to_string());
        if allow_swap_key {
            msg.modifiers = msg
                .modifiers
