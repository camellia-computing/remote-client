...
impl Client {
    ...
    async fn _start(
        ...
        if camellia_remote_protocol::is_ip_str(peer) {
            return Ok((
                (
        ...
        if camellia_remote_protocol::is_domain_port_str(peer) {
            return Ok((
                (
...
impl LoginConfigHandler {
    ...
    fn create_login_msg(
        ...
        let display_name = display_name
            ...
            .join(" ");
        #[cfg(not(target_os = "android"))]
        let my_platform = camellia_remote_protocol::whoami::platform().to_string();
        #[cfg(target_os = "android")]
    ...
    pub fn update_supported_decodings(&self) -> Message {
        ...
        let mut misc = Misc::new();
        misc.set_option(OptionMessage {
            supported_decoding: camellia_remote_protocol::protobuf::MessageField::some(decoding),
            ..Default::default()
        });
        let mut msg_out = Message::new();
        msg_out.set_misc(misc);
                ...
                if let Ok(Some(data)) = conn.next_timeout(50).await {
                    match data {
                        Data::SyncWinCpuUsage(cpu_usage) => {
                            camellia_remote_protocol::platform::windows::sync_cpu_usage(cpu_usage);
                        }
                        _ => {}
                    }
                }
...
async fn send_switch_login_request(
    ...
    msg_out.set_switch_sides_response(SwitchSidesResponse {
        ...
        lr: camellia_remote_protocol::protobuf::MessageField::some(
            lc.read()
                .unwrap()
...
pub trait Interface: Send + Clone + 'static + Sized {
    ...
    fn swap_modifier_mouse(
        &self,
        _msg: &mut camellia_remote_protocol::protos::message::MouseEvent,
    ) {
    }
...
pub enum Data {
    ...
    RemoveDirResult((i32, Option<String>)),
