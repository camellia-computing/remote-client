...
#[cfg(not(windows))]
#[no_mangle]
pub extern "C" fn camellia_remote_core_main() -> bool {
    #[cfg(not(any(target_os = "android", target_os = "ios")))]
...
#[cfg(windows)]
#[no_mangle]
pub extern "C" fn camellia_remote_core_main_args(args_len: *mut c_int) -> *mut *mut c_char {
...
pub extern "C" fn rustdesk_is_disable_installation() -> c_int {
    camellia_remote_protocol::config::is_disable_installation() as c_int
}
...
pub mod connection_manager {
    ...
    use camellia_remote_protocol::log;
    #[cfg(any(target_os = "android"))]
    ...
    #[cfg(target_os = "android")]
    use camellia_remote_protocol::tokio::sync::mpsc::{UnboundedReceiver, UnboundedSender};
...
pub(super) mod async_tasks {
    use camellia_remote_protocol::{bail, tokio, ResultType};
    use std::{
        collections::HashMap,
        sync::{
