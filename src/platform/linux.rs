...
pub use camellia_remote_protocol::platform::linux::*;
...
lazy_static::lazy_static! {
    pub static ref IS_X11: bool = camellia_remote_protocol::platform::linux::is_x11_or_headless();
...
pub fn is_locked() -> bool {
    ...
    // https://github.com/rustdesk/camellia_remote_protocol/blob/ebb4d4a48cf7ed6ca62e93f8ed124065c6408536/src/platform/linux.rs#L119
    if values.is_empty() {
...
pub fn elevate(args: Vec<&str>) -> ResultType<bool> {
    ...
    match cmd.to_str() {
        ...
        None => {
            camellia_remote_protocol::bail!("Failed to get current exe as str");
        }
    }
}
*/
    ...
    pub fn new(display: bool, idle: bool, sleep: bool) -> Self {
        Self {
            _handle: keepawake::Builder::default()
                ...
                .app_reverse_domain("com.camellia.remote")
                .create()
                .ok(),
        }
    }
